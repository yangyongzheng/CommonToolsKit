...
@class EqualWidthSegmentedView;

@protocol EqualWidthSegmentedViewDelegate <NSObject>
- (void)equalWidthSegmentedView:(EqualWidthSegmentedView *)segmentedView
                  didSelectItem:(SegmentedViewItem *)selectItem
                        atIndex:(NSUInteger)index;
@end

@interface EqualWidthSegmentedView : UIView
...
@property (nonatomic, weak) id <EqualWidthSegmentedViewDelegate> delegate;
...
- (instancetype)initWithFrame:(CGRect)frame
                ...
                configuration:(SegmentedViewConfiguration *)configuration
                     delegate:(id<EqualWidthSegmentedViewDelegate>)delegate NS_DESIGNATED_INITIALIZER;
/**
 初始化方法
...
/** 更新下标为index的item */
- (void)updateSegmentedViewItem:(SegmentedViewItem *)item
